...
import SubscribedEvents from './pages/subscribed-events/SubscribedEvents';
        ...
        <PlayerContextProvider>
          <BrowserRouter>
            <Routes>
              ...
              <Route path={RouterUrl.SUBCRIBED_EVENTS} element={<PrivateRoute><PrivateContainer title="Subscribed Events"><SubscribedEvents /></PrivateContainer></PrivateRoute>} />
