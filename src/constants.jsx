...
export const SFX_ANSWERS_MUSIC = "../public/sounds/answersMusic.mp3"
export const SFX_ANSWERS_SOUND = "../public/sounds/answersSound.mp3"
export const SFX_RESULTS_SOUND = "../public/sounds/results.mp3"
export const SFX_SHOW_SOUND = "../public/sounds/show.mp3"
export const SFX_BOUMP_SOUND = "../public/sounds/boump.mp3"
export const SFX_PODIUM_THREE = "../public/sounds/three.mp3"
export const SFX_PODIUM_SECOND = "../public/sounds/second.mp3"
export const SFX_PODIUM_FIRST = "../public/sounds/first.mp3"
export const SFX_SNEAR_ROOL = "../public/sounds/snearRoll.mp3"
